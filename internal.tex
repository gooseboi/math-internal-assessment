...
%
%\begin{itemize}
%	\item{Case 1: $0 < \alpha < 1$
%			\begin{flalign*}
%				D^\alpha \left(f+g\right) &= \frac{d}{dt} \frac{1}{\Gamma(\alpha)} \int_a^x \left(x-t\right)^{\alpha - 1} \left(f(t)+g(t)\right) \di t \\
%										  &= \frac{d}{dt} \frac{1}{\Gamma(\alpha)} \int_a^x \left(x-t\right)^{\alpha - 1} f(t) + \left(x-t\right)^{\alpha - 1} g(t) \di t \\
%										  &= \frac{d}{dt} \frac{1}{\Gamma(\alpha)} \left(\int_a^x \left(x-t\right)^{\alpha - 1} f(t) \di t + \int_a^x \left(x-t\right)^{\alpha - 1} g(t) \di t\right) \\
%										  &= \frac{d}{dt} \frac{1}{\Gamma(\alpha)} \int_a^x \left(x-t\right)^{\alpha - 1} f(t) \di t + \frac{d}{dt} \frac{1}{\Gamma(\alpha)} \int_a^x \left(x-t\right)^{\alpha - 1} g(t) \di t \\
%										  &= D^\alpha f + D^\alpha g
%		\end{flalign*}
%		}
%	\item{Case 2: $-1 < \alpha < 0$
%			\begin{flalign*}
%				D^\alpha \left(f+g\right) &= \frac{1}{\Gamma(\alpha)} \int_a^x \left(x-t\right)^{\alpha - 1} \left(f(t)+g(t)\right) \di t \\
%										  &= \frac{1}{\Gamma(\alpha)} \int_a^x \left(x-t\right)^{\alpha - 1} f(t) + \left(x-t\right)^{\alpha - 1} g(t) \di t \\
%										  &= \frac{1}{\Gamma(\alpha)} \left(\int_a^x \left(x-t\right)^{\alpha - 1} f(t) \di t + \int_a^x \left(x-t\right)^{\alpha - 1} g(t) \di t\right) \\
%										  &= \frac{1}{\Gamma(\alpha)} \int_a^x \left(x-t\right)^{\alpha - 1} f(t) \di t + \frac{d}{dt} \frac{1}{\Gamma(\alpha)} \int_a^x \left(x-t\right)^{\alpha - 1} g(t) \di t \\
%										  &= D^\alpha f + D^\alpha g
%		\end{flalign*}
%		}
%\end{itemize}
